...
public class LanguageIdentifier {
    ...
    private NativeLanguageIdentifier nativeLanguageIdentifier;
    ...
    public void enableLinguaService(File bin) {
        try {
            this.nativeLanguageIdentifier = new NativeLanguageIdentifier(bin);
        } catch (IOException e) {
    ...
    public DetectedLanguage detectLanguage(String cleanText, List<String> noopLangsTmp, List<String> preferredLangsTmp) {
        ...
        if (nativeLanguageIdentifier != null) {
            try {
                tmpResult = nativeLanguageIdentifier.detectLanguages(cleanText);
                result = getHighestScoringResult(tmpResult);
                additionalLangs.add("zz");
                return new DetectedLanguage(null,
                    Languages.getLanguageForShortCode(result.getKey().trim(), additionalLangs),
